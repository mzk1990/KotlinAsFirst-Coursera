 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = (sagenes * 48.0 + arshins * 16.0 + vershoks) * 4.445 / 100
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val summ = initial + initial * percent / 100.0
    val summ1 = summ + summ * percent / 100.0
    val summ2 = summ1 + summ1 * percent / 100.0
    return summ2
    /** надо бы почитать как одной переменной обойстись в котлине.*/
}
